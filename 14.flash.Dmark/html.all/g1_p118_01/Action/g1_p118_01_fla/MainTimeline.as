package g1_p118_01_fla
{
    ...
    dynamic public class MainTimeline extends MovieClip
    {
        ...
        public const _FUNC_START_DX:Number = -4;
        public const _FUNC_END_DX:Number = 4;
        public const _POINT_SIZE:uint = 3;
        public const _PLOT_NUM1:uint = 9;
        public const _PLOT_NUM2:uint = 17;
                ...
                case 41:
                {
                    ...
                    else if (this.Main_action != 0)
                    {
                        ...
                        if (this.Main_timer > this.disp_point_tbl[this.point_step_g].frame)
                        {
                            ...
                            this.point_counter = this.point_counter + this.disp_point_tbl[this.point_step_g].p_num;
                            this.Main_timer = 0;
                            var _loc_3:* = this;
                            var _loc_4:* = this.point_step_x + 1;
                            _loc_3.point_step_x = _loc_4;
        ...
        public function dispLinePointRandom(param1:int, param2:Number) : void
        {
            ...
            while (_loc_3 < param1)
            {
                ...
                _loc_4 = Math.random() * 10 + this._FUNC_START_DX;
        ...
        function frame1()
        {
            ...
            this.disp_point_tbl = [{no:1, frame:0, p_num:1, p_max:50, dlt_x:0.25 / 1, speed:0.02, p_size:this._POINT_SIZE}, {no:2, frame:0, p_num:1, p_max:50, dlt_x:0.25 / 2, speed:0.02, p_size:this._POINT_SIZE}, {no:3, frame:0, p_num:1, p_max:100, dlt_x:0.25 / 4, speed:0.02, p_size:this._POINT_SIZE}, {no:4, frame:0, p_num:1, p_max:800, dlt_x:0.25 / 8, speed:0.02, p_size:this._POINT_SIZE}, {no:5, frame:0, p_num:1, p_max:200, dlt_x:0.25 / 16, speed:0.02, p_size:this._POINT_SIZE}];
            this.random_point_num = [1, 2, 4, 5, 9, 9, 9, 9];
            this.initMainItem();
