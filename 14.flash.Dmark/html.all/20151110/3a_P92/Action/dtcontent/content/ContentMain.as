package dtcontent.content
{
    ...
    {
        public var adjustment:MovieClip;
        ...
        public function chkAfterClick(event:MouseEvent) : void
        {
            var event:* = event;
            try
            {
                this.mc.changeAfterimage();
            }
            catch (e:Error)
            {
                trace("chkAfterClick:" + e.message);
            }
            return;
        }// end function

        public function chageSlide(event:Event) : void
        {
            var event:* = event;
            try
            {
                this.btnStart.visible = true;
                this.btnStop.visible = false;
                this.mc.slideHandler(this.adjustment.btnSlider.x);
            }
            catch (e:Error)
            {
                trace("chageSlide:" + e.message);
            }
            return;
        }// end function

        public function animeSlide(event:Event) : void
        {
            var event:* = event;
            try
            {
                this.adjustment.btnSlider.x = this.mc.frameCnt;
            }
            catch (e:Error)
            {
                trace("animeSlide:" + e.message);
            }
            return;
        }// end function
        ...
        function frame1()
        {
            ...
            this.chkAfter.addEventListener(MouseEvent.CLICK, this.chkAfterClick);
            this.adjustment.addEventListener("moveSlide", this.chageSlide);
            this.mc.addEventListener("animeHandler", this.animeSlide);
            return;
        }// end function
