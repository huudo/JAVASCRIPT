package dtcontent.content
{
    ...
    dynamic public class ContentMain extends MovieClip
    {
        ...
        public function backHandler(event:MouseEvent) : void
        {
            ...
            try
            {
                switch(this.count)
                {
                    ...
                    case 2:
                    {
                        this.animation.gotoAndStop(221);
                        break;
                    }
                    default:
                    {
        ...
        {
            this.initialize();
            this.unitStep.stepMC = this.ansMC;
            ...
            this.resetBtn.addEventListener(MouseEvent.CLICK, this.resetHandler);
            this.count = 0;
            this.init();
            return;
        }// end function
