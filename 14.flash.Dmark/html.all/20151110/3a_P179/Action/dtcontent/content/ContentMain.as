package dtcontent.content
{
    ...
    dynamic public class ContentMain extends MovieClip
    {
        ...
        public function backHandler(event:MouseEvent) : void
        {
            ...
            {
                trace("backHandler:" + e.message);
            }
            return;
        }// end function

        public function firstHandler(event:MouseEvent) : void
        {
            var event:* = event;
            try
            {
        ...
        public function frameNext() : void
        {
            try
            {
                ...
                {
                    this.mc.gotoAndPlay(91);
                }
                else if (this.step == 3)
                {
                    this.mc.gotoAndPlay(221);
                }
                else if (this.step == 4)
                {
                    this.mc.gotoAndPlay(401);
                }
            }
            catch (e:Error)
            {
                trace("frameNext:" + e.message);
            }
            return;
        }// end function

        public function frameBack() : void
        {
            try
            {
                if (this.step == 0)
                ...
                {
                    this.mc.gotoAndStop(90);
                }
                else if (this.step == 2)
                {
                    this.mc.gotoAndStop(220);
                }
                else if (this.step == 3)
                {
                    this.mc.gotoAndStop(400);
                }
            }
            catch (e:Error)
            {
                trace("frameBack:" + e.message);
            }
            return;
        }// end function
        ...
        public function set captionVisible(param1:Boolean) : void
        {
            ...
            if (this.hasOwnProperty("dtCaption"))
            {
        ...
        function frame1()
        {
            this.initialize();
            this.init();
            this.btnNext.addEventListener(MouseEvent.CLICK, this.nextHandler);
            this.btnBack.addEventListener(MouseEvent.CLICK, this.backHandler);
            this.btnFirst.addEventListener(MouseEvent.CLICK, this.firstHandler);
