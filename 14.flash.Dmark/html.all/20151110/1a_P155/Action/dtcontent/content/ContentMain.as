package dtcontent.content
{
    ...
    dynamic public class ContentMain extends MovieClip
    {
        ...
        public function NextHandler(event:MouseEvent)
        {
            var event:* = event;
            try
            {
                this.btnInit();
                this.graph.gotoAndPlay("label_" + this.labelNum);
                var _loc_3:* = this;
                var _loc_4:* = this.labelNum + 1;
                _loc_3.labelNum = _loc_4;
                if (this.labelNum == this.labelMax)
                {
                    this.btnNext.visible = false;
                }
            }
        ...
        public function BackHandler(event:MouseEvent) : void
        {
            ...
            try
            {
                ...
                this.graph.gotoAndStop("label_" + this.labelNum);
            }
            catch (e:Error)
            {
        ...
        function frame1()
        {
            ...
            this.btnReset.addEventListener(MouseEvent.CLICK, this.ResetHandler);
            this.btnInit();
            this.init();
            return;
        }// end function
